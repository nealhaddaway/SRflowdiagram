...
First, we need to enter/load in the data:
```{r inputs}
search_results <- 'xxx'
other_results <- 'xxx'
unique_records <- 'xxx'
...
interact(plot, nodes, links)
```

This plot can then be manually exported as an HTML file.